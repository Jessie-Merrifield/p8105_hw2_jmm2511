...
there are four other participants that only appear in the baseline
dataset. From the anti-joined dataset, it is clear that these are
invalid entries because the current-age is lower than the age-at-onset.
